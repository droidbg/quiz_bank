...
const List<Question> _generalQuestions = [
  ...
  Question(
    ...
    difficulty: 2,
    explanation:
        'Yes, some cats can develop allergies to human dander, similar to how humans can be allergic to cats.',
  ),
  Question(
    ...
    difficulty: 1,
    explanation:
        'India drives on the left side of the road, a legacy from British colonial rule.',
  ),
  Question(
    ...
    difficulty: 2,
    explanation:
        'While not all Indians are vegetarian, a significant portion of the population follows vegetarian diets due to cultural and religious reasons.',
  ),
  Question(
  ...
  Question(
    ...
    difficulty: 1,
    explanation:
        'Squid Game is a South Korean television series created by Hwang Dong-hyuk.',
  ),
  ...
  Question(
    ...
    difficulty: 3,
    explanation:
        'Blue whales have extremely powerful hearts that can be detected from great distances underwater.',
  ),
  ...
  Question(
    ...
    difficulty: 3,
    explanation:
        'The loudest animal is actually the sperm whale, which can produce sounds up to 230 decibels. The African elephant produces sounds around 117 decibels.',
  ),
  Question(
    text:
